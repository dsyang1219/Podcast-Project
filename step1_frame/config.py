...
# Env-overridable: some CDNs (omny/podtrac) time out at 30s under 16-way
# concurrency even though the URLs are live. Raise for recovery passes.
HTTP_TIMEOUT = int(os.environ.get("PPC_HTTP_TIMEOUT", "30"))
HTTP_RETRIES = int(os.environ.get("PPC_HTTP_RETRIES", "3"))
USER_AGENT = (
