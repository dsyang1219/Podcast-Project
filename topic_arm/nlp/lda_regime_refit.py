...
token CSV under data/output/regimes/), this script:
  ...
  2. Flags "filler-like" topics: a topic is filler-like if >= FILLER_TOPIC_
     THRESHOLD of its top-10 words are in data/external/dictionaries/spoken_stopwords.txt (the
...
STOPWORD_FILE = Path("data/external/dictionaries/spoken_stopwords.txt")
